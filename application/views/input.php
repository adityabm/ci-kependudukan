	    ...
	    <center>
	      <table style="width: 700px" cellspacing="0">
	      	<tbody>
	      		<tr>
	      			<td width="50%">NIK</td>
	      			<td><input type="text" name="nik" maxlength="16" placeholder="NIK" required="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td>
	      		</tr>
	      		<tr>
	      		...
	      		<tr>
	      			...
	      			<td><input type="date" name="tanggal" placeholder="Tanggal Lahir" required=""></td>
	      		</tr>
	      		<tr>
	      			<td width="50%">Jenis Kelamin</td>
	      			<td>
	      				<label><input type="radio" name="jenis_kelamin" value="1" required="">Pria</label>
	      				<label><input type="radio" name="jenis_kelamin" value="0" required="">Wanita</label>
	      			</td>
	      		</tr>
	      		<tr>
	      			<td width="50%">Gol. Darah</td>
	      			<td>
	      				<label><input type="radio" name="gol_darah" value="a" required="">A</label>
	      				<label><input type="radio" name="gol_darah" value="b" required="">B</label>
	      				<label><input type="radio" name="gol_darah" value="o" required="">O</label>
	      				<label><input type="radio" name="gol_darah" value="ab" required="">AB</label>
	      			</td>
	      		</tr>
	      		<tr>
	      		...
	      		<tr>
	      			...
	      			<td>
	      				<textarea name="textarea" style="resize: vertical;" required=""></textarea>
	      			</td>
	      		</tr>
	      		<tr>
	      		...
	      		<tr>
	      			...
	      			<td>
	      				<label><input type="checkbox" name="kwg" value="1" required=""> WNI</label>
	      			</td>
	      		</tr>
	      		<tr>
	      			<td width="50%">Foto</td>
